...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        for (int t = 1; t <= T; t++) {
            ...
            double hieu2BanKinh = circles[i].getR() - circles[j].getR();
            if (khoangCachTuTamIDenTamJ < Math.abs(hieu2BanKinh)) {
                System.out.println("Circle " + i + " is inside Circle " + j);
            }
            else if (khoangCachTuTamIDenTamJ < tong2BanKinh && khoangCachTuTamIDenTamJ > Math.abs(hieu2BanKinh)) {
